...
<div class="blog-post">
  ...
  <p>This month we developed a system to create and train action recognition models using MediaPipe and data augmentation techniques to produce accurate models with less than 50 samples. We were able to introduce the model we trained into the main application that performs object detection.</p>
  <h4>Retrospective</h4>
